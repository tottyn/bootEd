...
# obtain studentized sampling distributions 

```{r, eval = FALSE}

# Check if the studentized distribution is pivotal - NORMAL POPULATION
...
# plot it
ggplot(boot_t_stats_data_all_long_norm) +
...
# Check if the studentized distribution is pivotal - EXPONENTIAL POPULATION
...
# plot it
ggplot(boot_t_stats_data_all_long) +
  geom_histogram(aes(bootstat, fill = as.factor(B)), position = "dodge", alpha = 0.8) +
...
# plot it
ggplot(boot_t_stats_data_all_long_bern) +
  geom_histogram(aes(bootstat, fill = as.factor(B)), position = "dodge", alpha = 0.8) +
